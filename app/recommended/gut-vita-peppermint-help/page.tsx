...
export default function GutVitaPeppermintHelp() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12">
      ...
      <h1 className="text-3xl font-bold text-amber-900 mb-6 leading-tight">
        Honey, Sometimes the Belly Needs More Than a Cup of Tea
      </h1>

      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        I have kept peppermint tea on my stove for over 40 years. It works.
        It has always worked. And I will never stop reaching for it after
        dinner every single evening.
      </p>

      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        But I hear from women all the time who say — Granny Dovie, I have
        been drinking the tea every night and my belly still will not fully
        settle. The bloating eases but it keeps coming back. The gas never
      ...
      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        Sometimes the gut has fallen so far out of balance that peppermint
        tea alone cannot do all the work. The good bacteria are outnumbered.
        The gut lining has taken damage. The digestive system needs more
        than a traditional remedy can deliver on its own.
      </p>
      ...
      <p className="text-lg text-stone-700 mb-8 leading-relaxed">
        For women whose gut health has struggled for years — not days —
      ...
      <div className="text-center mb-10">
        <Link
          ...
          target="_blank"
          onClick={() => trackPrelanderClick("does-peppermint-tea-help-bloating", "gut-vita-peppermint-help")}
      ...
      <div className="text-center mb-8">
        <Link
          href="/blog/does-peppermint-tea-help-bloating"
          className="text-amber-700 underline text-base"
        >
          ← Back to Does Peppermint Tea Help With Bloating
        </Link>
      </div>
