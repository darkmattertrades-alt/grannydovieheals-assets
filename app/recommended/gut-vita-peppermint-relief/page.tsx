...
export default function GutVitaPeppermintRelief() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12">
      ...
      <div className="mb-8 rounded-xl overflow-hidden">
        <Image
          ...
          alt="Granny Dovie's peppermint tea bloating relief remedy on a farmhouse table"
          width={1200}
          height={630}
      ...
      <h1 className="text-3xl font-bold text-amber-900 mb-6 leading-tight">
        Honey, When the Bloating Keeps Coming Back — Something Deeper Is Off
      </h1>
      ...
      <div className="text-center mb-10">
        <Link
          ...
          target="_blank"
          onClick={() => trackPrelanderClick("peppermint-tea-bloating-relief", "gut-vita-peppermint-relief")}
      ...
      <div className="text-center mb-8">
        <Link
          href="/blog/peppermint-tea-bloating-relief"
          className="text-amber-700 underline text-base"
        >
          ← Back to Peppermint Tea Bloating Relief
        </Link>
      </div>
