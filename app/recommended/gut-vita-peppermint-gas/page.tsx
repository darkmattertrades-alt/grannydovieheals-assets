...
export const metadata = {
  ...
  description:
    "When peppermint tea needs a little backup for bloating and gas, this is what Granny Dovie reaches for. Advanced gut support for women who want faster, stronger digestive results.",
  robots: "noindex",
}

export default function GutVitaPeppermintGasPreLander() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12">
      ...
      <div className="mb-8 rounded-xl overflow-hidden">
        <Image
          ...
          alt="Granny Dovie's peppermint tea remedy for bloating and gas on a farmhouse table"
          width={1200}
          height={630}
      ...
      <h1 className="text-3xl font-bold text-amber-900 mb-6 leading-tight">
        Honey, When the Bloating and Gas Keep Coming Back — This Is What I Reach For Next
      </h1>
      ...
      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        ...
        It works on bloating. It works on gas. It has always worked. And I
        will never stop reaching for it when the belly gives me trouble
        after a meal.
      </p>

      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        But I hear from women all the time who say — Granny Dovie, I have
        been drinking peppermint tea every single evening and the bloating
        and gas still will not quit. Something deeper is still off.
      </p>
      ...
      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        ...
        outnumbered. The gut lining has taken damage. The bloating and gas
        keep returning because the digestive system needs more than a
      ...
      <blockquote className="border-l-4 border-amber-600 pl-6 mb-8 italic text-stone-600 text-lg">
        "Peppermint tea is where I start with bloating and gas. But honey,
      ...
      <p className="text-lg text-stone-700 mb-8 leading-relaxed">
        For women whose bloating and gas have struggled for years — not
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-8">
        ...
        <ul className="space-y-3 text-stone-700 text-base">
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              Delivers results faster for women whose bloating and gas
      ...
      <div className="text-center mb-8">
        <Link
          href="/blog/peppermint-tea-bloating-and-gas"
          className="text-amber-700 underline text-base"
        >
          ← Back to Granny Dovie's Peppermint Tea for Bloating and Gas
        </Link>
      </div>
