...
export const metadata = {
  ...
  description:
    "When peppermint tea needs a little backup for a bloated stomach, this is what Granny Dovie reaches for. Advanced gut support for women who want faster, stronger digestive results.",
  robots: "noindex",
}

export default function GutVitaPeppermintBloatedStomachPreLander() {
  return (
    <main className="max-w-2xl mx-auto px-6 py-12">
      ...
      <div className="mb-8 rounded-xl overflow-hidden">
        <Image
          ...
          alt="Granny Dovie's peppermint tea remedy for a bloated stomach on a farmhouse table"
          width={1200}
          height={630}
      ...
      <h1 className="text-3xl font-bold text-amber-900 mb-6 leading-tight">
        Honey, When the Bloated Stomach Keeps Coming Back — This Is What I Reach For Next
      </h1>
      ...
      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        ...
        It works on a bloated stomach. It has always worked. And I will never
        stop reaching for it when the belly rounds out after a meal.
      </p>

      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        But I hear from women all the time who say — Granny Dovie, I have
        been drinking peppermint tea every single evening and the bloated
        stomach still will not quit. Something deeper is still off.
      </p>
      ...
      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        ...
        outnumbered. The gut lining has taken damage. The bloated stomach
        keeps returning because the digestive system needs more than a
        single leaf can deliver on its own.
      </p>
      ...
      <blockquote className="border-l-4 border-amber-600 pl-6 mb-8 italic text-stone-600 text-lg">
        "Peppermint tea is where I start with a bloated stomach. But honey,
        sometimes the belly needs something that goes deeper. For those
        nights when the tea alone is not enough — this is what I recommend."
      </blockquote>
      ...
      <p className="text-lg text-stone-700 mb-5 leading-relaxed">
        Peppermint tea relaxes the stomach wall, eases the gas, and settles
        the bloated stomach after a meal. That will never change in this
        kitchen. It is the first thing I reach for and the last thing I
        would ever give up.
      </p>
      ...
      <p className="text-lg text-stone-700 mb-8 leading-relaxed">
        For women whose bloated stomach has struggled for years — not
        days — that kind of targeted support can change everything.
      </p>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-8">
        ...
        <ul className="space-y-3 text-stone-700 text-base">
          ...
          <li className="flex items-start gap-3">
            ...
            <span>
              Delivers results faster for women whose bloated stomach
              has built up for months or years
            </span>
          </li>
          <li className="flex items-start gap-3">
      ...
      <div className="text-center mb-8">
        <Link
          href="/blog/peppermint-tea-bloated-stomach"
          className="text-amber-700 underline text-base"
        >
          ← Back to Granny Dovie's Peppermint Tea for Bloated Stomach
        </Link>
      </div>
